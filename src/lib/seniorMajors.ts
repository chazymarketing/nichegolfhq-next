...
export const SENIOR_MAJOR_EVENTS_2026: SeniorMajorEvent[] = [
  ...
  },
  {
    ...
    endDate: "2026-04-02",
    format: "54-hole stroke play",
    tournamentWebsite: "https://golfweekseniornation.com/Events",
    ...
    overview: "The Golfweek Senior Amateur Championship is an elite invitation-only stroke-play event on the national senior amateur calendar, contested over 54 holes at a world-class private venue each year. It sets itself apart from most senior invitationals with a deep national field and a rotating slate of top-ranked courses.",

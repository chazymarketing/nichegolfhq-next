    ...
    news: [
      {
        ...
        content: [
          ...
          "Names like Christian Cavaliere, Patrick Christovich, Seiji Liu, Jordan Nasser, and Taylor Wood round out a deep field where any number of players could contend over three rounds at LACC. midamgolfHQ will be tracking the action all week from Los Angeles.",
        ],
      },
    ],
    pastResults: [
